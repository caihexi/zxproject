...
<body>
	...
	<div id="page-body" role="main">
		<h1>
			<g:message code="cproject.title.label" default="Welcome to Grails" />
		</h1>
		<g:if test="${session.user?.userName}">
			<p>
				<g:message code="cproject.memo.label" default="Congratulations"
		...
		<g:else>
			<p>
				<g:link controller="cuser" action="index">
					<g:message code="cproject.pleaselogin.label"
