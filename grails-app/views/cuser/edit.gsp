...
<body>
	<a href="#edit-cuser" class="skip" tabindex="-1"><g:message
			code="default.link.skip.label" default="Skip to content&hellip;" /></a>

	<g:render template="/menu" /> 
	
	<div id="edit-cuser" class="content scaffold-edit" role="main">
		<h1>
		...
		<g:form method="post">
			...
			<g:hiddenField name="version" value="${cuserInstance?.version}" />
			<fieldset class="form">
